...
import 'package:databaseflutter/screens/edit/cubit/edit_task_cubit.dart';
import 'package:databaseflutter/screens/edit/edit.dart';
import 'package:databaseflutter/screens/home/bloc/task_list_bloc.dart';
import 'package:databaseflutter/widgets.dart';
...
class _TaskItemState extends State<TaskItem> {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      onLongPress: () {
        widget.task.delete();
        BlocProvider.of<TaskListBloc>(context).add(TaskListStarted());
      },
      child: Container(
